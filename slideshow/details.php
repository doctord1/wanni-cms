...
$my_addon_name = "slideshow"; 

$my_addon_desc = "For slideshows and content galleries"; // Short clear description of what addon does.

$version = "1.01.dev"; 

$config_path = "slideshow/config";

$settings_path = "slideshow";
