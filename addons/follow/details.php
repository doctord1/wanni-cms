...
$my_addon_name = "follow"; 

$my_addon_desc = "Maintains lists of pages or users you are following"; // Short clear description of what addon does.

$version = "1.01.dev"; 

$config_path = "follow/config";

$settings_path = "follow";
