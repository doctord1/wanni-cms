...
$my_addon_name = "referrals"; 

$my_addon_desc = "Tracks user referrals for rewards"; // Short clear description of what addon does.

$version = "0.01.dev"; 

$config_path = "referrals/config";

$settings_path = "referrals";
