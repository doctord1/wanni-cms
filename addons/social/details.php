...
$my_addon_name = "social"; 

$my_addon_desc = "Add and remove social media links"; // Short clear description of what addon does.

$version = "0.01.dev"; 

$config_path = "social/config";

$settings_path = "social";
