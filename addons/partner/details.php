...
$my_addon_name = "partner"; 

$my_addon_desc = "Add and partner, affiliate or sponsor"; // Short clear description of what addon does.

$version = "0.01.dev"; 

$config_path = "partner/config";

$settings_path = "partner";
