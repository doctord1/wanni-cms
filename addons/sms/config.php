...
CREATE TABLE IF NOT EXISTS `sms_gateways` (
  ...
  `gateway_path` varchar(150) NOT NULL,
...
if(isset($uninstall)){
	...
	$query = mysqli_query($GLOBALS["___mysqli_ston"], "DROP TABLE IF EXISTS `sms_gateways`");
	$query = mysqli_query($GLOBALS["___mysqli_ston"], "DROP TABLE IF EXISTS `sms_templates`");
