...
$my_addon_name = "rewards"; 

$my_addon_desc = "Controls rewards and points for users"; // Short clear description of what addon does.

$version = "0.01.dev"; 

$config_path = "rewards/config";

$settings_path = "rewards";
