...
$my_addon_name = "project_manager"; 

$my_addon_desc = "Handles project management and support tickets"; // Short clear description of what addon does.

$version = "0.01.dev"; 

$config_path = "project_manager/config";

$settings_path = "project_manager";
