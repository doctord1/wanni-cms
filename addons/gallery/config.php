...
$q1 = mysqli_query($GLOBALS["___mysqli_ston"], "CREATE TABLE IF NOT EXISTS `gallery` (
...
if($primary_menu_query){ echo "<br>Successfully installed primary menu block";}
...
if(isset($uninstall)){
	$q1 = mysqli_query($GLOBALS["___mysqli_ston"], "DROP TABLE IF EXISTS `gallery`");
	}
else { }	
