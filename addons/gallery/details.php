...
$my_addon_name = "gallery"; 

$my_addon_desc = "gallery grids for images or content"; // Short clear description of what addon does.

$version = "0.01.dev"; 

$config_path = "gallery/config";

$settings_path = "gallery";
