...
CREATE TABLE IF NOT EXISTS `draws` (
  ...
  `last_winner` varchar(150) NOT NULL,
  PRIMARY KEY (`id`)
...
block_create('active draws','Displays active draws with total, participants and time remaining','show_draws("active");','draws');
...
if(isset($uninstall)){
	$query = mysqli_query($GLOBALS["___mysqli_ston"], "DROP TABLE IF EXISTS `{$addon_name}`,`draw_participants`,`draw_winners`");
