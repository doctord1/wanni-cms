...
$query = mysqli_query($GLOBALS["___mysqli_ston"], "
CREATE TABLE IF NOT EXISTS `hashtagged_posts` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `hashtag` varchar(150) NOT NULL,
...
$query = mysqli_query($GLOBALS["___mysqli_ston"], "
CREATE TABLE IF NOT EXISTS `hashtag_participants` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
if(isset($uninstall)){
	$query = mysqli_query($GLOBALS["___mysqli_ston"], "DROP TABLE IF EXISTS `{$addon_name}`,`hashtagged_posts`,hashtag_participants`");
